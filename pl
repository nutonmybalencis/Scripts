...
local function addSelectedPlayerToWhitelist(optionText)
	...
	Window:Notify({
		Title = "Whitelist",
		Description = "Added " .. player.Name .. " to whitelist",
		Lifetime = 3
	})
...
local function removeSelectedPlayerFromWhitelist(optionText)
	...
	Window:Notify({
		Title = "Whitelist",
		Description = "Removed " .. player.Name .. " from whitelist",
		Lifetime = 3
	})
...
local function autoShoot()
    ...
    -- If we have a valid target, update linger state and proceed normally
...
if not success or not MacLib then
    ...
    -- Continue without UI or return here if you want
end
